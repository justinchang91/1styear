    ...
    while path.peek()[0] != end:
        ...
        if not current_position[1]["U"]:
            ...
            if valid_path_coordinate(maze, next_square) and not path.search(next_square):  # if the next square is valid
                path.push((next_square,
                           {"U": False, "D": True, "L": False, "R": False}))  # D is true cuz u already were there
        ...
        # Explore down:
            ...
            if valid_path_coordinate(maze, next_square) and not path.search(next_square):  # if it's true
                path.push((next_square,
                           {"U": True, "D": False, "L": False, "R": False}))  # U is true cuz u already were there
        ...
        # Explore left:
            ...
            if valid_path_coordinate(maze, next_square) and not path.search(next_square):  # if it's true
                path.push((next_square,
                           {"U": False, "D": False, "L": False, "R": True}))  # U is true cuz u already were there
        ...
        # Explore right:
            ...
            if valid_path_coordinate(maze, next_square) and not path.search(next_square):  # if it's true
                path.push((next_square,
                           {"U": False, "D": False, "L": True, "R": False}))  # U is true cuz u already were there
